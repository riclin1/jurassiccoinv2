...
uint256 hashGenesisBlock("0xcd844c071a1f6ff53b232638db0b55935092d6a5d689710223a804e9e84d1333");
...
const string strMessageMagic = "JurassicCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // JurassicCoin: 1 week
static const int64 nTargetSpacing = 180; // JurassicCoin: 3 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Jurassiccoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jurassiccoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JurassicCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x891b040ebfcf8bee13b61e0422473012b3a4b62880185ea512f32ee5daef0314");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "July 4th, 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1436182874; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3017772;

        if (fTestNet)
        {
            block.nTime    = 1435990407;
            block.nNonce   = 370178;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc066818cad9afb0000611bc34523bdbfdac8a8d52e7a9a1d2ba631209ca066b6"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Jurassiccoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
